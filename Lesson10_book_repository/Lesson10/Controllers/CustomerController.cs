...
namespace Lesson10.Data
{
    public class CustomerController : Controller
    {
        ...
        public IActionResult SelectWithSQL() {
            ...
            List<Customer> customers = dataContext.Customers.FromSql("select * from Customer").ToList();
        ...
        // dataContext is the context class
        {
            ...
            List<Customer> customers = dataContext.Customers.FromSql<Customer>(
        ...
        public ActionResult SelectFromSp()
        {
            ...
            List<Customer> customers = dataContext.Customers.FromSql<Customer>("exec CustomersByZip @Zip", zip).ToList();
        ...
        public ActionResult InsertCustomer()
        {
            ...
            dataContext.Database.ExecuteSqlCommand("Insert Into Customer (Name, Address, City, Zip) Values ('Tommy Andersen', 'Havvej 4', 'Aarhus', '8000')");
        ...
        {
            dataContext.Database.ExecuteSqlCommand("exec CreateCustomer @p0, @p1, @p2, @p3", parameters: new[] { "Tina Andersson", "Mågevej 124", "Malling", "8340" });
