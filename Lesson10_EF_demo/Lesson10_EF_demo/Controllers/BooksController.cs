...
namespace Lesson10_EF_demo.Controllers
{
    public class BooksController : Controller
    {
        private readonly Lesson10_EF_demoContext _context;

        public BooksController(Lesson10_EF_demoContext context)
        {
            _context = context;
        }
        ...
        {
            var lesson10_EF_demoContext = _context.Book.Include(b => b.Author);
            return View(await lesson10_EF_demoContext.ToListAsync());
        }
